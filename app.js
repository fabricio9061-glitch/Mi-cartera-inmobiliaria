  ...
  function renderMLStatus(d) {
    ...
    const _vis = d.visitas != null ? d.visitas : null;
    const _preg = d.preguntas || null;
    const _cwa = d.contactosWhatsapp != null ? d.contactosWhatsapp : null;
    const interaccion = (_vis != null || _preg || _cwa != null) ? `<div class="ml-section"><div class="ml-stats">${_vis != null ? `<div class="ml-stat"><i class="fas fa-eye" style="color:#1e9e6a"></i><div><div class="n">${_vis}</div><div class="t">visitas · últimos 30 días</div></div></div>` : ''}${_preg ? `<div class="ml-stat"><i class="fas fa-circle-question" style="color:#2e86de"></i><div><div class="n">${_preg.total != null ? _preg.total : 0}</div><div class="t">preguntas${_preg.sinResponder ? ` · ${_preg.sinResponder} sin responder` : ''}</div></div></div>` : ''}${_cwa != null ? `<div class="ml-stat"><i class="fab fa-whatsapp" style="color:#25d366"></i><div><div class="n">${_cwa}</div><div class="t">contactos WhatsApp · 30 días</div></div></div>` : ''}</div></div>` : '';
