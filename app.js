  ...
  // El tipo de padrón (Común / PH) es un dato del inmueble, no de la operación:
  // aplica igual a venta y a alquiler. Antes se ocultaba en alquiler y el guardado
  // lo forzaba a 'common', así que elegir PH en un alquiler no quedaba registrado.
  function togglePropertyType() {
    const g = document.getElementById('propertyTypeGroup');
  ...
  async function handleSaveProperty(e) {
    ...
    try {
      ...
      const pd = {
        ...
        type: ty,
        propertyType: document.getElementById('propPropertyType').value,
